...
<head>
    ...
    <link rel="stylesheet" href="styles/kitchen-style.css">
    <title>KITCHEN</title>
                <!-- Favicon -->
...
<body>
    ...
    <main class="main-content">
        <div class="container-withspace">
            <div class="categorie-name">KITCHEN</div>
            <div class="content-container">
                <div class="item bottom-sale-border-bedroom1">
                    
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen1.jpg" alt="KITCHEN">
                    </div>
                ...
                <div class="item bottom-sale-border-bedroom2">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen2.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                ...
                <div class="item bottom-sale-border-bedroom3">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen3.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                ...
                <div class="item bottom-sale-border-bedroom4">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen4.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                        <div class="item-name">well-arrange room
</div>
                ...
                <div class="item bottom-sale-border-bedroom1">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen5.jpg" alt="KITCHEN"></div>
                    <div class="description">
                ...
                <div class="item bottom-sale-border-bedroom2">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen6.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                ...
                <div class="item bottom-sale-border-bedroom3">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen7.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                        <div class="item-name">view of bedroom with spherical pendant lamp</div>
                ...
                <div class="item bottom-sale-border-bedroom4">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen8.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                        <div class="item-name">
                ...
                <div class="item bottom-sale-border-bedroom1">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen9.jpg" alt="KITCHEN">
                    </div>
                    <div class="description" >
                ...
                <div class="item bottom-sale-border-bedroom2">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen10.jpg" alt="KITCHEN">
                    </div>
                    <div class="description">
                ...
                <div class="item bottom-sale-border-bedroom3">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen11.jpg" alt="KITCHEN"></div>
                    <div class="description">
                ...
                <div class="item bottom-sale-border-bedroom4">
                    ...
                    <div class="close"></div>
                    <div class="img-div">
                        <img class="item-img" src="img/kitchen12.jpg" alt="KITCHEN"></div>
                    <div class="description">
